...
import { getMentorProfile } from "../../services/AccountService";
        ...
        <div className="flex justify-center flex-col items-center gap-20">
          ...
          <div className="w-full px-10 flex flex-col gap-4">
            ...
            <div className="border-t-1 pt-4 flex flex-col gap-4">
              <div className="flex justify-between">
                <span className="font-semibold">Trung bình đánh giá:</span>
                <span>{user?.trungBinhDanhGia}</span>
              </div>
              <div className="flex justify-between">
                <span className="font-semibold">Doanh thu:</span>
                <span>{user?.doanhThu}</span>
              </div>
            </div>

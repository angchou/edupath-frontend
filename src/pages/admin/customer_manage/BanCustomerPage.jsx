            ...
            <form action="" className="mt-5" onSubmit={handleSubmit}>
              <div className="flex flex-row gap-1">
                <select
                  ...
                  className="w-full p-2 border-b-1 outline-none focus:border-blue-500 basis-64"
                >
                ...
                <select
                  ...
                  className="w-full p-2 border-b-1 outline-none focus:border-blue-500 basis-128"
                >

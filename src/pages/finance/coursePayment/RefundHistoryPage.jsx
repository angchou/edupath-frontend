        ...
        <main className="flex-1 p-8">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-3 mb-6">
            <p className="text-sm text-gray-500">
              Tổng cộng {refunds.length} khách hàng
            </p>
            <SearchBar label="Tìm kiếm giao dịch hoàn tiền" />
          </div>
          ...
          <div className="bg-white w-full max-w-md rounded-xl shadow-lg p-6 relative">
            ...
            <div className="h-full flex flex-col items-center justify-center">
              ...
              <div className="mt-5 w-full flex flex-col gap-2">
                ...
                <div className="flex gap-3">
                  <span className="font-bold">Ngày tạo phiếu:</span>
                  {selectedRefund?.ngayTao}
                </div>
                <div className="flex gap-3">
                  <span className="font-bold">Ngày hoàn tiền:</span>
                  {selectedRefund?.ngayHT}
                </div>
                <div className="flex gap-3">

...
export default function MentorAccountSideBar() {
  const baseStyle =
  ...
  return (
    <div className="w-full md:w-64 bg-white border-b md:border-b-0 md:border-r border-gray-200">
      ...
      <nav className="px-4 pb-4 md:mt-6">
        ...
        <NavLink
          to="/mentor/profile/bank_account"
          className={({ isActive }) =>
            `${baseStyle} ${
              isActive
                ? "bg-blue-50 text-blue-600"
        ...
        >
          <Banknote size={20} />
          <span className="font-medium">Quản lý doanh thu</span>
        </NavLink>

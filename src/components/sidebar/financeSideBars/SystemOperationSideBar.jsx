import { Cog, Landmark, Receipt } from "lucide-react";
  ...
  return (
    <div className="w-full md:w-64 bg-white border-b md:border-b-0 md:border-r border-gray-200">
      ...
      <nav className="px-4 pb-4 md:mt-6">
        ...
        >
          <FaCoins size={20} />
          <span className="font-medium">Quản lý ngân sách</span>
        </NavLink>
        ...
        >
          <Receipt size={20} />
          <span className="font-medium">Quản lý chi phí khuyến mãi</span>
        </NavLink>
